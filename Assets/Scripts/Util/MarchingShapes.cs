...
namespace MRD.Rendering {
	public static class MarchingShapes {
		...
		public static MarchingShape marchingTetrahedron1 = new CustomMarchingShape(
			new Vector3Int[] {
				Vector3Int.zero,
		...
		public static MarchingShape marchingTetrahedron2 = new CustomMarchingShape(
			new Vector3Int[] {
				Vector3Int.zero,
		...
		public static MarchingShape marchingOctahedron = new CustomMarchingShape(
			new Vector3Int[] {
				Vector3Int.zero,
		...
		public static MarchingShape rdMarcher = new CombinedMarchingShape(
			new MarchingShape[] {
				marchingTetrahedron1,
				marchingTetrahedron2,
				marchingOctahedron
			});
	}
}
